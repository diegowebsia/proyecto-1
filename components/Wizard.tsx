...
const PLATFORMS = [
  { id: 'google', name: 'Google', icon: Globe, desc: '1 clic: inicias sesión con tu cuenta de empresa' },
  { id: 'trustpilot', name: 'Trustpilot', icon: Star, desc: 'Lo conectamos nosotros por ti en 1 clic' },
